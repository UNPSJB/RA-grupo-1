...
export const RegistroAlumno = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:8000/personas/registro", {
        method: "POST",
  ...
  const goLogin = () => navigate("/alumno/login");
  ...
  return (
    <div className="registro-alumno-page">
      {/* Pop-up de Error */}
      {showErrorPopup && (
      ...
      <Container className="d-flex flex-column align-items-center justify-content-center flex-grow-1 fade-in-up">
        ...
        <div className="registro-title-section text-center mb-2">
          <h6 className="registro-main-title">Registro de Alumno</h6>
        </div>
