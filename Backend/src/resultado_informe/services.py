...
def _crear_respuesta_db(informe_catedra_finalizado_id: int, pregunta_id: int, opcion_id: int | None = None, texto_respuesta: str | None = None) -> models.ResultadoInforme:
