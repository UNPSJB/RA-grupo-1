...
class Persona(ModeloBase):
    ...
    alumno: Mapped[Optional["Alumno"]] = relationship("Alumno", back_populates="persona", uselist=False)
    docente: Mapped[Optional["Docente"]] = relationship("Docente", back_populates="persona", uselist=False)